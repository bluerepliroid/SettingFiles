...
;;    Stefan Reich.ANvr <reichoer@riic.at>)
...
(ibuffer-define-column
 ;; the variable added in ibuffer-formats
 coding
 ;; the 1st line character
 (:name " coding ")
 ;; describe the function which returns the character code below here
